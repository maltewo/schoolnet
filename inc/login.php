...
<div class="row">
  ...
  <div class="col-md-4">
  	<form class="form-signin" style="margin-top: 50%; padding: 30px; display: block; background-color: white; border: 1px solid #ccc; border-radius:6px; vertical-align: middle; opacity=0.1;">
